...
from acapy_plugin_pickup.protocol.redis_queue import (
    RedisPersistedQueue,
    UndeliveredInterface
)
from acapy_plugin_pickup.protocol.delivery import DeliveryQueue
...
async def setup(context: InjectionContext):
    ...
    if persistence == "mem":
        ...
        queue = RedisPersistedQueue(redis=await aioredis.from_url(redis_uri))
    else:
        raise ValueError()
